...
const ListingDetails = () => {
  ...
  const { control, errors, isValid, handleSubmit, setFiles, files, isLoading } =
  ...
  return (
    <section className="min-h-full flex-col justify-center flex bg-[#F7F2EB] px-14 rounded-t-lg pt-20">
      <section className="grid grid-cols-3 gap-x-24">
        <PropertyCard property={currentProperty}>
          <PropertyDetails
            ...
            lotSizeValue={
              currentProperty.lotSizeValue !== undefined
                ? currentProperty.lotSizeValue
                : '0'
            }
              ...
              <Controller
                render={({ field: { onChange, value } }) => (
                  <BorderedTextInput
                    ...
                    value={value}
                    onChange={onChange}
                    error={errors?.name_on_property?.message}
                  />
                )}
                name="name_on_property"
                control={control}
              />
            </section>
            <section className="relative">
      ...
      <section className="flex items-center justify-between mt-20">
        ...
        <section className="flex items-center gap-x-4">
          ...
          <RoundedButton
            disabled={(!isValid && files.length < 1) || isLoading}
            label="Continue"
