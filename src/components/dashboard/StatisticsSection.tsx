  ...
  return (
    <section className="rounded-xl bg-white px-6 py-3">
      ...
      <section className="flex items-center gap-8">
        ...
        />
        <section className="flex flex-col items-center justify-center">
          <p className="text-black font-bold text-2xl">{result?.viewsCount}</p>
        ...
        />
        <section className="flex flex-col items-center justify-center">
          <p className="text-black font-bold text-2xl">{result?.totalOffers}</p>
        ...
        />
        <section className="flex flex-col items-center justify-center">
          <p className="text-black font-bold text-2xl">{result?.shareCount}</p>
