...
export const AGENT_BACKEND_SERVICE = process.env.NEXT_PUBLIC_AUTH_SERIVCE_GRAPHQL_URL || 'http://localhost:4000/graphql'
...
export const googleMapsApiKey = process.env.NEXT_PUBLIC_MAP_KEY
